...
export const FOUNDERS = [
  ...
  },
  {
    ...
    bio: "The digital heartbeat of HomeGround. Sparsh bridges the gap between grassroots sport and cutting-edge technology, building the platforms that let hundreds of players book, train, and compete every week. From the seamless booking engine to the social media presence that has made HomeGround go viral in Kandivali, Sparsh ensures the brand lives as powerfully online as it does on the turf. His tech-first mindset keeps HomeGround ahead of every competitor.",
...
export const SPORTS = [
  {
    ...
    accentGlow: "oklch(0.75 0.18 55 / 35%)",
    accentBorder: "oklch(0.75 0.18 55 / 40%)",
  ...
  },
  {
    ...
    accentGlow: "oklch(0.65 0.2 240 / 35%)",
    accentBorder: "oklch(0.65 0.2 240 / 40%)",
  ...
  },
  {
    ...
    accentColor: "oklch(0.8 0.2 125)",
    accentGlow: "oklch(0.8 0.2 125 / 35%)",
    accentBorder: "oklch(0.8 0.2 125 / 40%)",
