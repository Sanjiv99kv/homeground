...
import { Menu, X, User, LogOut, Calendar, Shield, Loader2 } from "lucide-react";
...
export default function Navbar() {
  ...
  const handleSignIn = () => {
    ...
    if (loginUrl === "#") {
      // OAuth not configured — show dev login modal
        ...
        <div className="container flex items-center justify-between h-18">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            {isAuthenticated ? (
              ...
              <Button variant="outline" size="sm" onClick={handleSignIn} data-signin-trigger className="border-border/50 hover:border-primary/50 transition-all duration-300">
                Sign In
              </Button>
            )}
            {!isBookingPage && (
            ...
            >
              <div className="container py-4 flex flex-col gap-1">
                ...
                {isAuthenticated ? (
                  ...
                  <Button size="sm" variant="outline" onClick={() => { handleSignIn(); setMobileOpen(false); }} className="mx-4">
                    Sign In
                  </Button>
                )}
                {!isBookingPage && (
        ...
        {showLoginModal && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="glass-card rounded-2xl p-8 w-full max-w-md mx-4 border border-border/50"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="text-center mb-6">
                <h2 className="font-heading text-2xl tracking-wider text-foreground mb-2">SIGN IN</h2>
                <p className="text-sm font-sans text-muted-foreground">Enter your details to continue</p>
              </div>
              <div className="space-y-4">
                <Input
                  ...
                  className="bg-card/50 border-border/50 h-12 rounded-xl font-sans focus:border-primary/50"
                ...
                />
                <Button
                  className="w-full bg-primary text-primary-foreground glow-primary font-sans font-bold h-12 rounded-xl hover:scale-[1.02] transition-all duration-300"
